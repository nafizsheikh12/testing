...
const CustomTooltip = ({ active, payload, label }) => {
  ...
  if (active && payload && payload.length) {
    ...
    return (
      <div className="custom-tooltip affiliate-dashboard-tooltip">
...
const DataCharts = () => {
  ...
  return (
    <>
      <div id="dashboardChart" className="managerdashboardchart">
        ...
        <ResponsiveContainer width='100%' height={500}>
          ...
          /> */}
            ...
            <Grid className="h6_dashboard" lg={5} md={4} xs={12}>
              <p>STATISTICS FOR THE LAST 15 DAYS</p>
           </Grid>
      </div>
    </>
  );
